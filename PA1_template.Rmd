...
First, I remove all variables from the environment
```{r setup}
#clean the memory and different var
rm(list=ls(all=TRUE)) 
```

Next, I have download the dataset required for this assignment.  Description of this data from course website: 
...
3. It is more funny to print directly on the histogram than with print function
